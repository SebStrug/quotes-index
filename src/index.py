...
WORD_ID_MAP = defaultdict(itertools.count().__next__)
...
def create_inverted_index(file_line_it: Iterator[str, str]) -> dict[int, list[str]]:
    ...
    Args:
        file_line_it: Iterator producing consecutive pairs of (<file-id>, <line-from-file>)
